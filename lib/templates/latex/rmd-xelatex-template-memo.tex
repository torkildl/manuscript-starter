%
% RMarkdown template for memo-style documents.
% Features only the title and subtitle, author name(s) with affiliation(s) and main text.
% 
%
...
\hyphenpenalty=1500 % default 50
\tolerance=700      % default 200
